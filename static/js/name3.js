    ...
    var tablename='';
      ...
      // Append table with add row form on add new button click
        ...
        var index = $("table tbody tr:last-child").index();
            ...
            row = row + '<td>' + '<a class="add" title="Add" data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></a><a class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a><a class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE872;</i></a><p id="getaction">0101</p>' + '</td>' + '</tr>';
