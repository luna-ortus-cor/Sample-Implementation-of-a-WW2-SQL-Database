$(document).ready(function(){
  ...
  if(tab=='7' || tab=='0'){
    ...
    var countrycols=["Name", "Max Ground Strength", "No. of Armor", "No. of Carriers", "No. of Battleships", "No. of Cruisers", "No. of Destroyers", "No. of Submarines", "No. of Fighters", "No. of Bombers", "Armor Lost", "Aircraft Lost", "Carriers Lost", "Battleships Lost", "Cruisers Lost", "Destroyers Lost", "Submarines Lost", "Military Casualties", "Civilian Casualties"];
    ...
    var countryvar=['NAME', 'MAXGSTR', 'NUMARMOR', 'NUMCV', 'NUMBB', 'NUMC', 'NUMDD', 'NUMSS', 'NUMFIGHT', 'NUMBOMB', 'NUMARMORL', 'NUMAIRCRAFTL', 'NUMCVL', 'NUMBBL', 'NUMCL', 'NUMDDL', 'NUMSSL', 'MCASUALTY', 'CCASUALTY'];
    ...
    var axisforcecols=['Country', 'Military name', 'Axis ID']
    var axisforcevar=['MCNAME', 'MNAME', 'AXISKEY']
    var alliedforcecols=['Country', 'Military name', 'Allied ID']
    var alliedforcevar=['MCNAME', 'MNAME', 'ALLIEDKEY']
    var axiscols=['ID']
    var axisvar=['ID']
    var alliedcols=['ID']
    var alliedvar=['ID']
    var axisforcePK=axisforcecols.slice(0,3); var axisforceK=axisforcecols.slice(3);
    var alliedforcePK=alliedforcecols.slice(0,3); var alliedforceK=alliedforcecols.slice(3);
    var axisPK=axiscols.slice(0,1); var axisK=axiscols.slice(1);
    var alliedPK=alliedcols.slice(0,1); var alliedK=alliedcols.slice(1);
    ...
    var tablename='';
                  ...
                  PK=shipPK;
                  K=shipK;
                } else if(tname == "Military under Command"){
                  aItems = commandmcols;
                  aVar = commandmvar;
                  aType=commandmtype;
                  PK=commandmPK;
                  ...
                  PK=eventPK;
                  K=eventK;
                } else if(tname == "Battle Info"){
                  aItems = hascols;
                  aVar = hasvar;
                  aType=hastype;
                  PK=hasPK;
                  K=hasK;
                } else if(tname == "Ship Info"){
                  aItems = hasscols;
                  aVar = hassvar;
                  aType=hasstype;
                  PK=hassPK;
                  ...
                  PK=warPK;
                  K=warK;
                } else if (tname=="Axis Force"){
                    aItems = axisforcecols;
                    aVar = axisforcevar;
                    //aType=wartype;
                    PK=axisforcePK;
                    K=axisforceK;
                }else if(tname=="Allied Force"){
                    aItems = alliedforcecols;
                    aVar = alliedforcevar;
                    //aType=wartype;
                    PK=alliedforcePK;
                    K=alliedforceK;
              ...
              $('#tab4selectallcountry').click(function() {
                if (this.checked) {
                    $('.countries2').each(function() {
                        this.checked = true;                        
                    });
                } else {
                   $('.countries2').each(function() {
             ...
             $('#tab4selectallvar').click(function() {
              if (this.checked) {
           ...
           $('#tab3selectallcountry').click(function() {
            if (this.checked) {
         ...
         $('#tab3selectallvar').click(function() {
          if (this.checked) {
              $('.stats').each(function() {
                  this.checked = true;                        
              });
    ...
    //var country=['Stronger Than', 'Weaker Than', 'Number Stronger Than', 'Number Weaker Than']; to check for country strength by certain variable
    var country=['Stronger Than', 'Weaker Than'];
    ...
    document.getElementById("tables7").addEventListener("change", function(e){
		var select7 = document.getElementById("sort7");
        var by7=document.getElementById("by7");
		select7.innerHTML = "";
        by7.innerHTML="";
		var aItems = [];
	if(this.value == "Commander"){
